...
export class EvolutionWebhookController {
  static async handle(req: Request, res: Response) {
    ...
    // Em serverless (Vercel) o setImmediate roda DEPOIS do response e a função
    // encerra antes de terminar, perdendo a entrega do webhook ao consumidor.
    // Processa SÍNCRONO (antes do 200) pra garantir que a entrega complete.
    try {
